...
public class LegacyKeyspace implements Keyspace {
	 ...
	 * @throws UnsupportedOperationException if CQL is not supported by the underlying driver
	 * @throws Exception if a problem occurs
	 */
	 ...
	 * @param options additional options (see http://www.datastax.com/docs/1.0/configuration /storage_configuration)
	 * @param log log to write to (may be null)
	 * @throws UnsupportedOperationException if the underlying driver does not support creating keyspaces
	 * @throws Exception if a problem occurs
	 */
	 ...
	 * @throws Exception if the named column family does not exist in the keyspace or a problem occurs
	 */
	 ...
	 * @throws UnsupportedOperationException if the underlying driver does not support updating column family schema
	 *           information
	 * @throws Exception if a problem occurs
	 */
	 ...
	 * @param log log to write to (may be null)
	 * @throws UnsupportedOperationException if the underlying driver does not support truncating a column family
	 * @throws Exception if a problem occurs
	 */
